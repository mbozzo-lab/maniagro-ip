...
export default function ActividadesJavierPage() {
  const [filters, setFilters] = useState<ActividadFilters>(emptyFilters);

  return (
    <div className="flex flex-col gap-6 max-w-7xl">
      <div>
        <h2 className="text-lg font-semibold text-slate-800">Actividades — Javier</h2>
      ...
      <Card>
        <EmptyState
          ...
          description="Esta sección estará disponible próximamente para el seguimiento de actividades de Javier."
        />
      </Card>
    </div>
  );
